...
| <img src="https://cdn.simpleicons.org/chocolatey/80B5E3" width="14" height="14" /> **Chocolatey** | `choco install localpdf-studio` | v0.17.2 `.nupkg` 생성 검증 완료, `CHOCO_API_KEY` 주입 후 push |
...
| <img src="https://cdn.simpleicons.org/homebrew/FBB040" width="14" height="14" /> **Homebrew** | `brew tap jeiel85/tap && brew install --cask localpdf-studio` | v0.17.2 DMG URL/SHA 반영 완료 |
