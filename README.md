...
| 매니저 | 명령어 | 상태 |
|---|---|---|
| <img src="https://cdn.simpleicons.org/windowsterminal/4D4D4D" width="14" height="14" /> **winget** | `winget install jeiel85.LocalPDFStudio` | v0.17.2 PR 제출 완료, 공식 소스 반영 대기 ([microsoft/winget-pkgs#377220](https://github.com/microsoft/winget-pkgs/pull/377220)) |
| <img src="https://cdn.simpleicons.org/chocolatey/80B5E3" width="14" height="14" /> **Chocolatey** | `choco install localpdf-studio` | v0.17.2 community push 완료, moderation/검색 반영 대기 |
| <img src="https://cdn.simpleicons.org/snapcraft/82BEA0" width="14" height="14" /> **Snap** | `sudo snap install localpdf-studio` | v0.17.2 `.deb` URL/SHA 반영 완료, Store 등록 대기 |
| <img src="https://cdn.simpleicons.org/archlinux/1793D1" width="14" height="14" /> **AUR** | `yay -S localpdf-studio-bin` | v0.17.2 PKGBUILD URL/SHA 반영 완료, AUR 등록 대기 |
| <img src="https://cdn.simpleicons.org/homebrew/FBB040" width="14" height="14" /> **Homebrew** | `brew tap jeiel85/tap && brew install --cask localpdf-studio` | v0.17.2 Cask tap 게시 완료 |
