...
| 매니저 | 명령어 | 상태 |
|---|---|---|
| <img src="https://cdn.simpleicons.org/windowsterminal/4D4D4D" width="14" height="14" /> **winget** | `winget install jeiel85.LocalPDFStudio` | v0.15.0 매니페스트/SHA 반영 완료, microsoft/winget-pkgs PR 예정 |
| <img src="https://cdn.simpleicons.org/chocolatey/80B5E3" width="14" height="14" /> **Chocolatey** | `choco install localpdf-studio` | v0.15.0 패키지/SHA 반영 완료, community 큐 제출 예정 |
| <img src="https://cdn.simpleicons.org/snapcraft/82BEA0" width="14" height="14" /> **Snap** | `sudo snap install localpdf-studio` | v0.15.0 snapcraft.yaml 반영 완료, 등록 예정 |
| <img src="https://cdn.simpleicons.org/archlinux/1793D1" width="14" height="14" /> **AUR** | `yay -S localpdf-studio-bin` | v0.15.0 PKGBUILD/SHA 반영 완료, 등록 예정 |
